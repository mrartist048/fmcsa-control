...
function injectTopRightProfileBar() {
    ...
    topBar.innerHTML = `
        <div style="position: relative;">
            ...
            <div id="dlProfileDropdownList" style="display: none; position: absolute; right: 0; top: 45px; background: var(--dropdown-bg); border: 1px solid var(--dropdown-border); box-shadow: 0 10px 25px rgba(0,0,0,0.15); border-radius: 8px; width: 180px; z-index: 1000000; padding: 6px; box-sizing: border-box;">
                <div onclick="changeDispatcherName(); closeProfileDropdown();" class="dropdown-item">✏️ Edit Name</div>
                <div onclick="openEmailSetupDrawer(); closeProfileDropdown();" class="dropdown-item">✉️ Email Setup</div>
                <div onclick="openSettingsModal(); closeProfileDropdown();" class="dropdown-item">⚙️ Portal Settings</div>
