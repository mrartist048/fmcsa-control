...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        /* MODAL STYLES FOR AUTOMATED SUMMARY */
...
<body>
    ...
    <div class="admin-layout">
        ...
        <div class="sidebar" id="appSidebar">
            ...
            <div class="sidebar-menu">
                ...
                <button onclick="switchTab('audit')" id="tabAudit" class="nav-btn">
                    <span>📊</span> Audit Trail & Logs
                </button>
            </div>
        </div>
        ...
        <div class="main-wrapper">
            ...
            <!-- FILTERS FOR REPORTS, LEADERBOARD & AUDIT -->
    ...
    <script>
        ...
        function isTimestampInRange(ts) {
            if (!ts) return false;
            let dStr = new Date(ts).toISOString().split('T')[0];
            if (filterMode === 'all') return true;
            return dStr >= startDateStr && dStr <= endDateStr;
        }
        ...
        function copySummaryText() {
            let text = document.getElementById('modalSummaryBody').innerText;
