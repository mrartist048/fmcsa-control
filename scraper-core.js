...
// Har naye load ya duplicate par bilkul alag unique runtime ID generate hogi
...
async function checkGlobalSessions() {
    ...
    try {
        ...
        const offlineThreshold = 12000; // 12 seconds
...
// ====== RESTORED ADVANCED FILTER BAR UI ======
