...
function injectHistoryUIFramework() {
    ...
    if (mainHeading && !document.getElementById('devCreditTag')) {
        ...
        creditTag.innerHTML = (currentClient && currentClient.toLowerCase() === "nexteklogistics") ? "Developed by <b>Mr. Nauman</b>" : "Developed by <b>Mr. Nauman (Ph: 03700684849)</b>";
    ...
    filterDiv.innerHTML = `
        <div style="display: flex; flex-wrap: wrap; align-items: center; gap: 10px; flex: 1;">
            ...
            <div style="display: flex; align-items: center; gap: 6px; flex: 1; min-width: 200px;">
                ...
                <input type="text" id="universalSearchInput" placeholder="Search by MC, Company, Phone..." style="width: 100%; padding: 6px 10px; font-size: 12px; border: 1px solid #b6ccfe; border-radius: 4px;" oninput="applyAdvancedFilters()">
            </div>

            <button onclick="resetAdvancedFilters()" style="background: #002d62; color: white; border: none; padding: 6px 14px; font-size: 12px; font-weight: bold; border-radius: 4px; cursor: pointer; white-space: nowrap;">🔄 Reset</button>
        </div>
